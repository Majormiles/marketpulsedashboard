...
const SellerToAdmin = () => {
    ...
    return (
        <div className='px-2 lg:px-7 py-5'>
            <div className='w-full bg-[#283046] pl-20 pr-20 px-4 py-4 rounded-md h-[calc(100vh-140px)]'>
                        ...
                        <div className='flex justify-between items-center'>
                            <div className='flex justify-start items-center gap-3'>
                                <div className='relative'>
                                    {/* <img className='w-[42px] h-[42px] border-green-500 border-2 max-w-[42px] p-[2px] rounded-full' src="/assets/admin.jpg" alt="" /> */}
                                    {
