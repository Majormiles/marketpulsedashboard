...
const SellerDashboard = () => {
    ...
    const chartState = {
        ...
        options: {
            chart: {
                type: 'line', // Use line chart instead of bar
                background: 'transparent',
                foreColor: '#d0d2d6'
            },
            colors: ['#1E90FF', '#28a745', '#ffc107'], // Different colors for each series
            dataLabels: {
                enabled: false
            },
            stroke: {
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                <div className='flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3'>
                    <div className='flex flex-col justify-start items-start text-[#d0d2d6]'>
                        <h2 className='text-3xl font-bold'>GH₵{totalSale}</h2>
                        ...
                        <tbody>
                            {
                                recentOrders.map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>GH₵{d.price}</td>
